...
// ── Category tree ────────────────────────────────────────────────────────────
// Parents carry the tax rate for their section; children inherit it.
// Coffee & matcha live under Getränke (19%). Essen is all 7%.
const CATEGORY_TREE = [
  { parent: 'Getränke', tax: 'standard', children: [
    { name: 'Softdrinks',  tax: 'standard', sort: 10 },
    { name: 'Bier & Wein', tax: 'standard', sort: 20 },
    { name: 'Cocktails',   tax: 'standard', sort: 30 },
    { name: 'Aperitifs',   tax: 'standard', sort: 40 },
    { name: 'Shots',       tax: 'standard', sort: 50 },
    { name: 'Iced Coffee', tax: 'standard', sort: 60 },
    { name: 'Iced Matcha', tax: 'standard', sort: 70 },
    { name: 'Warm Coffee', tax: 'standard', sort: 80 },
  ]},
  { parent: 'Essen', tax: 'reduced', children: [
    { name: 'Finger Food',                   tax: 'reduced', sort: 10 },
    { name: 'Nudeln - Suppe',                tax: 'reduced', sort: 20 },
    { name: 'Nudeln - Trocken',              tax: 'reduced', sort: 30 },
    { name: 'Reis',                          tax: 'reduced', sort: 40 },
    { name: 'Dessert',                       tax: 'reduced', sort: 50 },
    { name: 'Mittagsangebot (Mo-Fr 11:30-15:00)', tax: 'reduced', sort: 60 },
  ]},
...
const PRODUCTS: SeedProduct[] = [
  // ── SOFTDRINKS (19%) ──────────────────────────────────────────────────────
  { name: 'Trade Island Iced Tea 0,33l', category: 'Softdrinks', price_cents: 400, sort_order: 10,
    variants: [{ name: 'Peach (zuckerfrei)', price_cents: 0 }, { name: 'Pfirsich', price_cents: 0 },
               { name: 'Pomegranate', price_cents: 0 }, { name: 'Mango Maracuja', price_cents: 0 },
               { name: 'Blaubeeren', price_cents: 0 }, { name: 'Mint-Lime', price_cents: 0 },
               { name: 'Lemon-Lime', price_cents: 0 }, { name: 'Cherry Cassis (zuckerfrei)', price_cents: 0 }] },
  { name: 'Hausgemachte Limonade 0,4l', category: 'Softdrinks', price_cents: 500, sort_order: 20 },
  { name: 'Cola',            category: 'Softdrinks', price_cents: 400, sort_order: 30 },
  { name: 'Fanta',           category: 'Softdrinks', price_cents: 400, sort_order: 40 },
  { name: 'Sprite',          category: 'Softdrinks', price_cents: 400, sort_order: 50 },
  { name: 'Ginger Ale',      category: 'Softdrinks', price_cents: 400, sort_order: 60 },
  { name: 'Saft / Schorle 0,4l', category: 'Softdrinks', price_cents: 500, sort_order: 70,
    variants: [{ name: 'Orange', price_cents: 0 }, { name: 'Maracuja', price_cents: 0 },
               { name: 'Ananas', price_cents: 0 }, { name: 'Banane', price_cents: 0 },
               { name: 'Kirsch', price_cents: 0 }] },
  { name: 'Apfelsaft/schorle', category: 'Softdrinks', price_cents: 400, sort_order: 80 },
  { name: 'Mate 0,5l', category: 'Softdrinks', price_cents: 400, sort_order: 90,
    variants: [{ name: 'MioMio Original', price_cents: 0 }, { name: 'MioMio Ginger', price_cents: 0 }] },
  { name: 'Redbull', category: 'Softdrinks', price_cents: 400, sort_order: 100,
    variants: [{ name: 'original', price_cents: 0 }, { name: 'weiß', price_cents: 0 }, { name: 'zero', price_cents: 0 }] },
  { name: 'Wasser 0,33l', category: 'Softdrinks', price_cents: 250, sort_order: 110,
    variants: [{ name: 'ohne Sprudel', price_cents: 0 }, { name: 'mit Sprudel', price_cents: 0 }] },
  { name: 'Wasser 1l', category: 'Softdrinks', price_cents: 500, sort_order: 120,
    variants: [{ name: 'ohne Sprudel', price_cents: 0 }, { name: 'mit Sprudel', price_cents: 0 }] },
  { name: 'Tee', category: 'Softdrinks', price_cents: 300, sort_order: 130 },

  // ── BIER & WEIN (19%) ─────────────────────────────────────────────────────
  { name: 'Helles 0,33l',       category: 'Bier & Wein', price_cents: 350, sort_order: 10 },
  { name: 'Helles vom Fass 0,4l', category: 'Bier & Wein', price_cents: 450, sort_order: 20 },
  { name: 'Radler 0,33l',       category: 'Bier & Wein', price_cents: 350, sort_order: 30 },
  { name: 'Spezial 0,33l',      category: 'Bier & Wein', price_cents: 350, sort_order: 40 },
  { name: 'Helles 0,5l',        category: 'Bier & Wein', price_cents: 450, sort_order: 50 },
  { name: 'Hefeweizen hell 0,5l', category: 'Bier & Wein', price_cents: 450, sort_order: 60 },
  { name: 'Bananenweizen 0,5l', category: 'Bier & Wein', price_cents: 500, sort_order: 70 },
  { name: 'Apfelwein 0,4l',     category: 'Bier & Wein', price_cents: 500, sort_order: 80,
    variants: [{ name: 'süß', price_cents: 0 }, { name: 'sauer', price_cents: 0 },
               { name: 'pur', price_cents: 0 }, { name: 'cola', price_cents: 0 }] },
  { name: 'Wein 0,2l',          category: 'Bier & Wein', price_cents: 600, sort_order: 90,
    variants: [{ name: 'schorle', price_cents: 0 }, { name: 'rot', price_cents: 0 }, { name: 'weiß', price_cents: 0 }] },
  { name: 'Flasche Wein 0,75l', category: 'Bier & Wein', price_cents: 1800, sort_order: 100,
  ...
  { name: 'Fireball Sour',         category: 'Cocktails', price_cents: 900,  sort_order: 30 },
  ...
  { name: 'Shot', category: 'Shots', price_cents: 250, sort_order: 20,
    variants: [{ name: 'Berliner Luft', price_cents: 0 }, { name: 'Vodka', price_cents: 0 },
               { name: 'Tequila', price_cents: 0 }, { name: 'Jägermeister', price_cents: 0 },
               { name: 'Fireball', price_cents: 0 }, { name: 'sonstiges', price_cents: 0 }] },
  ...
  // ── MITTAGSANGEBOT (Mo-Fr 11:30–15:00, 7%) ───────────────────────────────
  { name: 'Phở', category: 'Mittagsangebot (Mo-Fr 11:30-15:00)', price_cents: 1200, sort_order: 10,
    variants: [{ name: 'Rindfleisch', price_cents: 0 }, { name: 'Tofu (Vegan)', price_cents: 0 }] },
  { name: 'Cơm Chiên', category: 'Mittagsangebot (Mo-Fr 11:30-15:00)', price_cents: 1100, sort_order: 20,
    variants: [{ name: 'Hähnchen', price_cents: 0 }, { name: 'Rind', price_cents: 0 },
               { name: 'Ente', price_cents: 100 }, { name: 'Garnelen', price_cents: 100 }] },
  { name: 'Cơm Chiên Chay (Vegan)', category: 'Mittagsangebot (Mo-Fr 11:30-15:00)', price_cents: 1000, sort_order: 30 },
  { name: 'Popcorn Chicken with Fries', category: 'Mittagsangebot (Mo-Fr 11:30-15:00)', price_cents: 1100, sort_order: 40 },
  { name: 'Bánh Mì', category: 'Mittagsangebot (Mo-Fr 11:30-15:00)', price_cents: 700, sort_order: 50,
    variants: [{ name: 'Classic (Schweinefleisch, Pate)', price_cents: 0 }, { name: 'Vegetarisch (Tofu)', price_cents: 0 }] },
  { name: '+ Softdrink (beim Kauf einer Speise)', category: 'Mittagsangebot (Mo-Fr 11:30-15:00)', price_cents: 300, sort_order: 60,
  ...
  { name: '+ Hausgemachte Limo (beim Kauf einer Speise)', category: 'Mittagsangebot (Mo-Fr 11:30-15:00)', price_cents: 400, sort_order: 70 },
